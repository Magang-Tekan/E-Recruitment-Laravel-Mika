<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div
            class="p-5 bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] flex items-center gap-4">
            <div
                class="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-500/10 dark:text-sky-400 dark:border dark:border-blue-500/20 flex items-center justify-center shrink-0">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-[#93A5C9]">Lowongan
                    Aktif</p>
                <div class="flex items-baseline gap-2 mt-1">
                    <span class="text-2xl font-bold text-slate-900 dark:text-white">{{ $activeJobs }}</span>
                    @if (!$isRecruiter)
                        <span class="text-xs text-slate-500 dark:text-[#7E90B5]">dari {{ $totalJobs }} total</span>
                    @else
                        <span class="text-xs text-emerald-600 dark:text-[#93F514] font-medium">Siap Diseleksi</span>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div
            class="p-5 bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] flex items-center gap-4">
            <div
                class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-[#93F514] dark:border dark:border-emerald-500/20 flex items-center justify-center shrink-0">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    ...
                    <span class="text-xs text-emerald-600 dark:text-[#93F514] font-medium">Lamaran Masuk</span>
                </div>
            </div>
        </div>
        ...
        <div
            class="p-5 bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] flex items-center gap-4">
            <div
                class="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 dark:bg-amber-500/10 dark:text-amber-400 dark:border dark:border-amber-500/20 flex items-center justify-center shrink-0">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-[#93A5C9]">Perlu
                    Review</p>
                <div class="flex items-baseline gap-2 mt-1">
                    <span class="text-2xl font-bold text-amber-600 dark:text-amber-400">{{ $pendingReview }}</span>
                    <span class="text-xs text-slate-500 dark:text-[#7E90B5]">Berkas/Screening</span>
                </div>
            </div>
        </div>
        ...
        <div
            class="p-5 bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] flex items-center gap-4">
            <div
                class="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 dark:bg-purple-500/10 dark:text-purple-400 dark:border dark:border-purple-500/20 flex items-center justify-center shrink-0">
                @if (!$isRecruiter)
            ...
            <div>
                @if (!$isRecruiter)
                    <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-[#93A5C9]">Ujian &
                        Bank Soal</p>
                    <div class="flex items-baseline gap-2 mt-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div
            class="lg:col-span-2 bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] p-6 flex flex-col justify-between">
            <div>
                    ...
                    <table class="w-full text-left text-sm border-collapse">
                        <thead>
                            <tr
                                ...
                                <th class="py-3 px-3 text-[11px] tracking-wider w-[42%]">Kandidat</th>
                                <th class="py-3 px-3 text-[11px] tracking-wider w-[24%]">Posisi</th>
                                <th class="py-3 px-3 text-[11px] tracking-wider w-[20%]">Tanggal</th>
                                <th class="py-3 px-3 text-[11px] tracking-wider text-center w-[14%]">Status</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-slate-50/70 dark:hover:bg-[#14203A]/60 transition-colors">
                                    ...
                                    <td class="py-3.5 px-3 align-middle">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-9 h-9 min-w-[36px] min-h-[36px] max-w-[36px] max-h-[36px] rounded-full bg-blue-50 text-blue-700 dark:bg-[#14203A] dark:text-[#93F514] border border-blue-200/60 dark:border-[#253D75] flex items-center justify-center font-bold text-xs uppercase shadow-sm shrink-0">
                                    ...
                                    <!-- Status Column -->
                                    <td class="py-3.5 px-3 align-middle text-center whitespace-nowrap">
                                        @php
        ...
        <div class="space-y-6">
            <div
                class="bg-white dark:bg-[#0D1527] rounded-2xl shadow-sm border border-slate-200/80 dark:border-[#1D2E54] p-6">
                ...
                <div class="grid grid-cols-2 gap-3">
                    @if ($isAdmin)
                        <a href="{{ route('admin.job') }}"
                            class="p-3 bg-slate-50 dark:bg-[#14203A] border border-transparent dark:border-[#1D2E54] hover:bg-blue-50 dark:hover:bg-[#1D2E54] text-slate-700 dark:text-slate-200 rounded-xl transition text-center flex flex-col items-center gap-2 group">
                            <div
                                class="w-10 h-10 rounded-xl bg-blue-100/60 dark:bg-blue-500/15 text-blue-600 dark:text-sky-400 dark:border dark:border-blue-500/20 flex items-center justify-center transition group-hover:scale-110">
                            ...
                            <span
                                class="text-xs font-semibold group-hover:text-blue-600 dark:group-hover:text-[#93F514] transition-colors">Lowongan</span>
                        </a>
                    @else
                        <a href="{{ $candidateRoute }}"
                            class="p-3 bg-slate-50 dark:bg-[#14203A] border border-transparent dark:border-[#1D2E54] hover:bg-blue-50 dark:hover:bg-[#1D2E54] text-slate-700 dark:text-slate-200 rounded-xl transition text-center flex flex-col items-center gap-2 group">
                            ...
                            <span
                                class="text-xs font-semibold group-hover:text-blue-600 dark:group-hover:text-[#93F514] transition-colors">Kandidat</span>
                        </a>
                    @endif

                    <a href="{{ $applicationRoute }}"
                        class="p-3 bg-slate-50 dark:bg-[#14203A] border border-transparent dark:border-[#1D2E54] hover:bg-emerald-50 dark:hover:bg-[#1D2E54] text-slate-700 dark:text-slate-200 rounded-xl transition text-center flex flex-col items-center gap-2 group">
                        <div
                            class="w-10 h-10 rounded-xl bg-emerald-100/60 dark:bg-emerald-500/15 text-emerald-600 dark:text-[#93F514] dark:border dark:border-emerald-500/20 flex items-center justify-center transition group-hover:scale-110">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                                </path>
                        ...
                        <span
                            class="text-xs font-semibold group-hover:text-emerald-600 dark:group-hover:text-[#93F514] transition-colors">Pelamar</span>
                    </a>

                    @if ($isAdmin)
                        <a href="{{ route('admin.test') }}"
                            class="p-3 bg-slate-50 dark:bg-[#14203A] border border-transparent dark:border-[#1D2E54] hover:bg-purple-50 dark:hover:bg-[#1D2E54] text-slate-700 dark:text-slate-200 rounded-xl transition text-center flex flex-col items-center gap-2 group">
                            <div
                                class="w-10 h-10 rounded-xl bg-purple-100/60 dark:bg-purple-500/15 text-purple-600 dark:text-purple-400 dark:border dark:border-purple-500/20 flex items-center justify-center transition group-hover:scale-110">
                    ...
                    <a href="{{ $isAdmin ? route('admin.test_evaluation') : route('recruiter.test_evaluation') }}"
                        class="p-3 bg-slate-50 dark:bg-[#14203A] border border-transparent dark:border-[#1D2E54] hover:bg-amber-50 dark:hover:bg-[#1D2E54] text-slate-700 dark:text-slate-200 rounded-xl transition text-center flex flex-col items-center gap-2 group">
                        <div
                            class="w-10 h-10 rounded-xl bg-amber-100/60 dark:bg-amber-500/15 text-amber-600 dark:text-amber-400 dark:border dark:border-amber-500/20 flex items-center justify-center transition group-hover:scale-110">
                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-[#1D2E54]">
                    ...
                    @if ($isAdmin)
                        <a href="{{ route('admin.job') }}"
                            class="text-xs font-semibold text-blue-600 hover:text-blue-700 dark:text-[#93F514] dark:hover:text-[#aef74b] transition">Lihat</a>
                    @endif
                </div>
                <div class="mt-3 divide-y divide-slate-100 dark:divide-[#1D2E54]/60">
                    @forelse($recentJobs as $job)
                        <div class="py-3 flex items-center justify-between">
                            ...
                            <span
                                class="px-2.5 py-1 text-xs font-bold bg-blue-50 text-blue-700 dark:bg-sky-500/15 dark:text-sky-300 dark:border dark:border-sky-500/30 rounded-lg">
                                {{ $job->job_applications_count }} Pelamar
                            </span>
                        </div>
                    @empty
                        <p class="py-4 text-center text-xs text-slate-400 dark:text-[#889BC2]">Belum ada lowongan.</p>
                    @endforelse
                </div>
            </div>
        </div>
